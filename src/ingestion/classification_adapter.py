...
def run(
    ...
    sink = JsonlClassificationSink(labels_path=output_labels_path, review_path=output_review_path)
...
if __name__ == "__main__":
    run(
        ...
        source_mode="html",
        input_dir="data/raw/wiki/html",
        db_path="data/raw/wiki/wiki_registry.db",
        output_labels_path="artifacts/docs/page_labels_ingestion.jsonl",
        output_report_path="artifacts/docs/classification_report_ingestion.json",
        output_review_path="artifacts/docs/review_queue_ingestion.jsonl",
